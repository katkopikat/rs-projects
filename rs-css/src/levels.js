...
export default [
  ...
  {
    level: 'Level 5 of 10',
    doThis: 'Destroy all the planets beyond Earth! ',
    selector: ['#earth ~ .planet', '#earth~.planet', '#earth~.div', '#earth ~ .div'],
    selectorName: 'General Sibling Selector',
    helpTitle: 'Select elements with an ID',
    syntax: 'A ~ B',
    describe: 'You can select all siblings of an element that follow it. This is like the Adjacent Selector (A + B) except it gets all of the following elements instead of one.',
    examples: [
      '<strong>A ~ B</strong> selects all <tag> B </tag> that follow a <tag> A </tag>.',
    ],
  },
  {
    level: 'Level 6 of 10',
    doThis: 'Destroy first planet near Death Star',
    selector: ['.solar-system:first-child', 'div:first-child'],
  ...
  {
    level: 'Level 8 of 10',
    doThis: 'Destroy first Gas Giant planet!',
    selector: ['.gas-gigant:first-of-type'],
    selectorName: 'First of Type Selector',
    helpTitle: 'Select the first element of a specific type',
    syntax: ':first-of-type',
    describe: 'Selects the first element of that type within another element.',
    examples: [
  ...
  },
  {
    ...
    selector: ['.planet:not([have-life="true"])', '.planet:not([have-life])'],

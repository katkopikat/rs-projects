...
const createRandomPets = () => {
  ...
  let sum = [];
  for (let i = 0; i < 6; i++) {
    let arr = createPets(fullPetsList);
...
const nextBtn = document.querySelector('.btn-next'),
  ...
  lastBtn = document.querySelector('.btn-last'),
  firstBtn = document.querySelector('.btn-first'),
  currentBtn = document.querySelector('.btn-pag--curency');
